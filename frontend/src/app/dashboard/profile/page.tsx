                ...
                user !== null && (
                    <>
                        ...
                        <div className="flex flex-col w-full xl:flex-row gap-3">
                            <section
                                className="bg-foreground text-white nightMode flex flex-col items-center p-5 rounded-xl xl:h-[calc(100vh-50px-1.75rem)]">
                                <div className="mb-3">
                                    <Avatar size={70}/>
                                </div>
                            ...
                            <section
                                className="bg-foreground text-white nightMode flex flex-col items-center p-5 rounded-xl gap-3 xl:gap-5 xl:flex-1 xl:items-start xl:h-[calc(100vh-50px-1.75rem)]">
                                ...
                                <div className="flex flex-col w-full gap-5 xl:flex-row xl:w-9/12 xl:gap-10">
                                    <form action="" className="flex flex-col gap-3 w-full xl:gap-8 xl:w-9/12">
                                        ...
                                        <Input isRequired isClearable value={user.email} name="email" type="email"
                                               variant="bordered" label="Email" placeholder="Votre Email"
                                               classNames={styles}/>
                                        <Input
                                            isRequired
                                            label="Mot de passe"
                                    ...
                                    <div className="flex flex-col gap-2 items-center xl:w-6/12 xl:gap-5 ">
                                        ...
                                        <div
                                            className="flex flex-col justify-between w-full items-center border border-primary gap-2 rounded-lg p-3 xl:gap-0 xl:flex-row">
                                            ...
                                            <div
                                                className={`flex gap-2 items-center ${user.github_login ? 'bg-green-500 border-green-700' : 'bg-red-500 border-red-700'} border rounded-full px-3 w-max h-max`}>
                                        ...
                                        <div
                                            ...
                                            <div
                                                className={`flex gap-2 items-center ${user.dribbble_login ? 'bg-green-500 border-green-700' : 'bg-red-500 border-red-700'} border rounded-full px-3 w-max h-max`}>
