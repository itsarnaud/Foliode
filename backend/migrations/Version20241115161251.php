 ...
 */
final class Version20241115161251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tools_projects (tools_id INT NOT NULL, projects_id UUID NOT NULL, PRIMARY KEY(tools_id, projects_id))');
